...
import cc.wsapps.sys.entity.RoleResourceRef;
import java.util.ArrayList;
import java.util.List;

public class RoleResourceRefExamplePage {
    ...
    public RoleResourceRefExamplePage() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andEntityEqualTo(RoleResourceRef e) {
            addCriterion("ID =", e.getId(), "id");
            addCriterion("ROLE_CODE =", e.getRoleCode(), "roleCode");
            addCriterion("RESOURCE_CODE =", e.getResourceCode(), "resourceCode");
