...
public class ResourceExamplePage {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andEntityEqualTo(Resource e) {
            addCriterion("ID =", e.getId(), "id");
            addCriterion("CODE =", e.getCode(), "code");
            addCriterion("NAME =", e.getName(), "name");
            addCriterion("TYPE =", e.getType(), "type");
            addCriterion("MODULE_CODE =", e.getModuleCode(), "moduleCode");
            addCriterion("VALUE =", e.getValue(), "value");
            addCriterion("DESCRIPTION =", e.getDescription(), "description");
            addCriterion("CREATER =", e.getCreater(), "creater");
            addCriterion("CREATED_DATE =", e.getCreatedDate(), "createdDate");
            addCriterion("UPDATER =", e.getUpdater(), "updater");
            addCriterion("UPDATED_DATE =", e.getUpdatedDate(), "updatedDate");
            addCriterion("IS_DEL =", e.getIsDel(), "isDel");
            return (Criteria) this;
        }
    }
